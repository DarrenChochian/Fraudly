...
description: >-
Learn how to integrate Amazon Connect telephony with Deepgram Voice Agent to
build real-time conversational AI with function calling.
--------------------------------------------------------
...
Review our [function calling docs](/voice-agent/function-calling) for more details.
