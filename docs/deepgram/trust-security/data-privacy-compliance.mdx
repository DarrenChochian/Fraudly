...
For customers requiring data processing within the European Union, Deepgram provides an EU-specific endpoint at `api.eu.deepgram.com`. See our [Configuring Custom Endpoints](/reference/custom-endpoints#eu-endpoints) documentation for more information.
