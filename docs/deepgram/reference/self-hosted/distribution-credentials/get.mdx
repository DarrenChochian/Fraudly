...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/self-hosted/distribution/credentials/distribution_credentials_id")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/self-hosted/distribution/credentials/distribution_credentials_id', [
  'headers' => [
