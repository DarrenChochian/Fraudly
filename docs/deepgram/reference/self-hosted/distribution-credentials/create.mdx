...
HttpResponse<String> response = Unirest.post("https://api.deepgram.com/v1/projects/project_id/self-hosted/distribution/credentials")
...
$response = $client->request('POST', 'https://api.deepgram.com/v1/projects/project_id/self-hosted/distribution/credentials', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
