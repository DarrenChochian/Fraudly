...
const options = {
  ...
  body: '{"email":"jane.doe@example.com","scope":"read_write"}'
};
...
HttpResponse<String> response = Unirest.post("https://api.deepgram.com/v1/projects/project_id/invites")
...
$response = $client->request('POST', 'https://api.deepgram.com/v1/projects/project_id/invites', [
  'body' => '{
  "email": "jane.doe@example.com",
  "scope": "read_write"
}',
