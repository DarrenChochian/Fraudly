...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/invites/email';
const options = {
  method: 'DELETE',
...
url = URI("https://api.deepgram.com/v1/projects/project_id/invites/email")
...
HttpResponse<String> response = Unirest.delete("https://api.deepgram.com/v1/projects/project_id/invites/email")
...
$response = $client->request('DELETE', 'https://api.deepgram.com/v1/projects/project_id/invites/email', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
...
var client = new RestClient("https://api.deepgram.com/v1/projects/project_id/invites/email");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/invites/email")! as URL,
