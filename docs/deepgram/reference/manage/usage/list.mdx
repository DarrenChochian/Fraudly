...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/usage/fields';
...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/usage/fields")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/usage/fields', [
  'headers' => [
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/usage/fields")! as URL,
