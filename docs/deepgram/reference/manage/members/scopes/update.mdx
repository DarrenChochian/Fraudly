...
HttpResponse<String> response = Unirest.put("https://api.deepgram.com/v1/projects/project_id/members/member_id/scopes")
...
$response = $client->request('PUT', 'https://api.deepgram.com/v1/projects/project_id/members/member_id/scopes', [
  'body' => '{
  "scope": "read_write"
}',
  'headers' => [
...
let parameters = ["scope": "read_write"] as [String : Any]
