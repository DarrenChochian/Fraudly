...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/keys/key_id';
const options = {
  method: 'DELETE',
...
HttpResponse<String> response = Unirest.delete("https://api.deepgram.com/v1/projects/project_id/keys/key_id")
...
$response = $client->request('DELETE', 'https://api.deepgram.com/v1/projects/project_id/keys/key_id', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
...
var client = new RestClient("https://api.deepgram.com/v1/projects/project_id/keys/key_id");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/keys/key_id")! as URL,
