...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/leave';
const options = {
  method: 'DELETE',
...
HttpResponse<String> response = Unirest.delete("https://api.deepgram.com/v1/projects/project_id/leave")
...
$response = $client->request('DELETE', 'https://api.deepgram.com/v1/projects/project_id/leave', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/leave")! as URL,
