...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/models/model_id';
...
url = URI("https://api.deepgram.com/v1/projects/project_id/models/model_id")
...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/models/model_id")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/models/model_id', [
  'headers' => [
...
var client = new RestClient("https://api.deepgram.com/v1/projects/project_id/models/model_id");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/models/model_id")! as URL,
