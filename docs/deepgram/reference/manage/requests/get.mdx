...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/requests/request_id';
const options = {
  method: 'GET',
...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/requests/request_id")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/requests/request_id', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/requests/request_id")! as URL,
