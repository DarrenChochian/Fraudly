...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/purchases';
...
url = URI("https://api.deepgram.com/v1/projects/project_id/purchases")
...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/purchases")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/purchases', [
  'headers' => [
...
var client = new RestClient("https://api.deepgram.com/v1/projects/project_id/purchases");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/purchases")! as URL,
