...
```javascript
const url = 'https://api.deepgram.com/v1/projects/project_id/balances';
const options = {
  method: 'GET',
...
HttpResponse<String> response = Unirest.get("https://api.deepgram.com/v1/projects/project_id/balances")
...
$response = $client->request('GET', 'https://api.deepgram.com/v1/projects/project_id/balances', [
  'body' => '{}',
  'headers' => [
    'Authorization' => 'Token <apiKey>',
    'Content-Type' => 'application/json',
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.deepgram.com/v1/projects/project_id/balances")! as URL,
