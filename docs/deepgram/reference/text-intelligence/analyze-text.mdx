...
payload = { "url": "https://example.com/articles/spacewalk-history.txt" }
headers = {
...
const options = {
  ...
  body: '{"url":"https://example.com/articles/spacewalk-history.txt"}'
};
...
func main() {
	...
	payload := strings.NewReader("{\n  \"url\": \"https://example.com/articles/spacewalk-history.txt\"\n}")
...
let parameters = ["url": "https://example.com/articles/spacewalk-history.txt"] as [String : Any]
