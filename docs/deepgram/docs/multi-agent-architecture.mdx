...
subtitle: >-
Create a multi-agent architecture using Deepgram's Voice Agent API, where
specialized agents handle different phases of customer interactions through
seamless handoffs.
slug: docs/multi-agent-architecture
-----------------------------------
