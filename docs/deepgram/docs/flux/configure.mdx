...
title: Configure
subtitle: >-
Send a Configure message to update Flux stream settings in real-time without
reconnecting.
slug: docs/flux/configure
-------------------------
...
* [Keyterm Boosting](/docs/custom-vocabulary/keyterm) - Detailed guide to using keyterms for custom vocabulary
