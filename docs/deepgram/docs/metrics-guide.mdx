...
# HELP flux_max_streams The max number of flux streams that can be processed on the GPU
# TYPE flux_max_streams gauge
flux_max_streams <integer>
# HELP flux_used_streams The number of flux streams that are being processed on the GPU
# TYPE flux_used_streams gauge
flux_used_streams <integer>
# HELP flux_fraction_streams The fraction of flux streams that are being processed on the GPU
# TYPE flux_fraction_streams gauge
flux_fraction_streams <float>
# HELP flux_cursor_latency  The cursor latency as measured inside impeller, after transcoding and rate-limiting
# TYPE flux_cursor_latency gauge
flux_cursor_latency <float>
```
