...
title: Redact Usage
subtitle: >-
Configure usage data redaction in your self-hosted Deepgram deployment to
enhance privacy and comply with security requirements.
slug: docs/self-hosted-redact-usage
-----------------------------------
