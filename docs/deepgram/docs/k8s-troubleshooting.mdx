...
subtitle: >-
If you encounter any challenges while deploying or maintaining your Deepgram
self-hosted services on Kubernetes, please consult this guide.
slug: docs/k8s-troubleshooting
------------------------------
