...
subtitle: Self-Hosted Deployment with Docker/Podman
slug: docs/deploy-tts-services
description: >-
Deploy Deepgram's TTS services including Aura-2 for conversational AI voice
synthesis
---------
